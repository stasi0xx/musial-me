                                ...
                                <div className="p-6 md:p-10 flex flex-col gap-6">
                                    ...
                                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-black pb-6">
                                        ...
                                        <div className="flex flex-wrap gap-3 font-sans text-xs uppercase tracking-widest text-gray-600">
                                            <span className="border border-black px-2 py-1">{project.metaType}</span>
                                            <span className="border border-black px-2 py-1">{project.metaYear}</span>
                                            <span className="border border-black px-2 py-1 bg-black text-white font-bold">{project.metaCategory}</span>
                                        </div>
                                    </div>
