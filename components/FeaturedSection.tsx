    ...
    return (
        <section id={featured.id} className="w-full border-t-4 border-black border-b border-black py-4 mb-12 overflow-x-auto [&::-webkit-scrollbar]:hidden">
            <div className="flex items-center min-w-max">
                ...
                {/* Trailing Link */}
                <Link href="/blog" className="ml-auto pl-6 border-l border-gray-300 flex items-center gap-2 text-xs uppercase tracking-wider font-bold cursor-pointer hover:underline">
                    <span>Więcej</span>
